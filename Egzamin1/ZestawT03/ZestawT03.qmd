...
Zad.1. Odwzoruj wykres znajdujący się w pliku graficznym c3.png znajdującym się folderze. Odcienie kolorów mogą się różnić, jednak główne barwy muszą być zachowane.
Zapisz powstały wykres w formacie png.

Zad.2. W jednym pliku wykonaj poniższe czynności:

* załaduj dane z pliku licea3.xlsx jako ramkę danych (Data Frame),
...
* załaduj dane z pliku produkcja3.xlsx,
* uporządkuj dane tak, aby odpowiednie dane były zaprezentowane w kolumnach (zgodnie z koncepcją czystych danych),
* stwórz wykres wykres liniowy na podstawie danych
